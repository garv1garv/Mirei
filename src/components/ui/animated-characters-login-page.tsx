  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background font-sans text-foreground">
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground overflow-hidden">
        ...
        <div className="absolute inset-0 bg-white/[0.05] bg-[size:30px_30px] opacity-20" />
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-primary-foreground/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="flex items-center justify-center p-8">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2">Welcome Access</h1>
            <p className="text-muted-foreground text-sm">Please identify your profile</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-sm font-medium">Username / Email</Label>
              <Input
                id="email"
                type="text"
                placeholder="chhavi"
                ...
                required
                className="h-12 border-border/60 focus:border-primary shadow-sm"
              />
            </div>

            <div className="space-y-2" style={{ visibility: email.toLowerCase() === 'chhavi' ? 'hidden' : 'visible' }}>
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 pr-10 border-border/60 focus:border-primary shadow-sm"
                />
                <button
                  type="button"
            ...
            <Button 
              type="submit" 
              className={`w-full h-12 text-base font-medium transition-all ${email.toLowerCase() === 'chhavi' ? 'bg-[#ff85a1] hover:bg-[#ffb5a7] text-white' : ''}`} 
              size="lg" 
              disabled={isLoading}
            >
              {isLoading ? "Authenticating..." : (email.toLowerCase() === 'chhavi' ? "Log in as Chhavi 💖" : "Log in")}
            </Button>
          </form>
